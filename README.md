![example workflow](https://github.com/schactye/yamdb_final/actions/workflows/yamdb_workflow.yml/badge.svg)
...
Зайдите на http://84.201.165.63/api/v1/ ,http://84.201.165.63/redoc/ и убедитесь, что страница отображается полностью: статика подгрузилась.
